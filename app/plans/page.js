...
import { PLANS as STATIC_PLANS } from "../../lib/data";
  ...
  return (
    <div className="plans-page">
      ...
      <div className="plans-header">
        ...
        <p className="fade-up-2">From beginner-friendly Starter to the institutional-grade Titan — there is a plan for every investor.</p>
