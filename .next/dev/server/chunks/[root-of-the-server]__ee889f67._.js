...
"[project]/app/api/plans/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function seedIfEmpty() {
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["plansDb"].getAll();
    if (existing.length === 0) {
        for (const plan of __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLANS"]){
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["plansDb"].upsert(plan);
        }
    }
}
async function GET() {
    try {
        await seedIfEmpty();
        const plans = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["plansDb"].getAll();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            plans: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLANS"]
        });
    }
}
async function PUT(request) {
    try {
        ...
        if (!updated.id) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Plan id required."
        }, {
            status: 400
        });
        const plan = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["plansDb"].update(updated.id, updated);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            plan
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee889f67._.js.map